<?php
class ControllerCustomReconciliation extends Controller {
	public function index() {
		$this->load->language('custom/reconciliation');
        ...
        $data['action']= $this->url->link('custom/reconciliation', 'token=' . $this->session->data['token'], true);
        $data['header'] = $this->load->controller('common/header');
        $data['column_left'] = $this->load->controller('common/column_left');
        $data['footer'] = $this->load->controller('common/footer');
		$this->response->setOutput($this->load->view('custom/reconciliation.tpl', $data	));
	}
